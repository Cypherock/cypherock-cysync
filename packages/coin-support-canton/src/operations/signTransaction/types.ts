...
import { SignTxnEvent } from '@cypherock/sdk-app-canton';

export type ISignCantonTransactionParams = ISignTransactionParams;

export type ISignCantonTransactionEvent = ISignTransactionEvent<string>;

export const signCantonToDeviceEventMap: Partial<
