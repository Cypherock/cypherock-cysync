...
import { coingeckoPlatformReverseMapping, getCoingeckoCoinDetails, } from './coingecko';
import { config } from './config';
import { getERC20TokenDifference } from './diff';
var MAX_RETRIES = 3;
var SLEEP_TIME = 10000;
var BATCH_LEN = 20;
var COIN_DETAILS_PATH = path.join(config.DATA_FOLDER, 'coinDetails');
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                _a.label = 1;
            case 1:
                promises = idsToFetch.map(function (id) { return getCoingeckoCoinDetails(id); });
...
var getAllCoinDetails = function (ids) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                allCoinDetails = {};
                chunkArray = lodash.chunk(ids, BATCH_LEN);
                totalFetched = 0;
            ...
            case 3:
                ...
                detail = details_1[_a];
                return [4 /*yield*/, fs.promises.writeFile(path.join(COIN_DETAILS_PATH, "".concat(detail.id, ".json")), JSON.stringify(detail, undefined, 2))];
            case 4:
                _b.sent();
...
var getExistingCoinDetails = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!!fs.existsSync(COIN_DETAILS_PATH)) return [3 /*break*/, 2];
                return [4 /*yield*/, fs.promises.mkdir(COIN_DETAILS_PATH, { recursive: true })];
            case 1:
                _a.sent();
                _a.label = 2;
            case 2: return [4 /*yield*/, fs.promises.readdir(COIN_DETAILS_PATH)];
            case 3:
                files = _a.sent();
                map = {};
                _i = 0, files_1 = files;
            ...
            case 4:
                ...
                file = files_1[_i];
                filePath = path.join(COIN_DETAILS_PATH, file);
...
export var createNewErc20List = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_h) {
        switch (_h.label) {
            case 0: return [4 /*yield*/, getERC20TokenDifference()];
            case 1:
                list = _h.sent();
                uniqueIds = lodash.uniq(list.filter(function (e) { return !e.is_zero_value_coin; }).map(function (e) { return e.id; }));
                return [4 /*yield*/, getExistingCoinDetails()];
            case 2:
                existingCoinDetails = _h.sent();
                existingCoinDetailsIds = Object.keys(existingCoinDetails);
                remaingIds = lodash.difference(uniqueIds, existingCoinDetailsIds);
                console.log({
            ...
            case 3:
                ...
                _loop_1 = function (coin) {
                    ...
                    if (coin.is_zero_value_coin) {
                        ...
                        newCoinList.push(__assign(__assign({}, coin), { platforms: Object.entries((_b = coin.platforms) !== null && _b !== void 0 ? _b : {}).reduce(function (a, v) {
                                var _a;
                                var _b, _c, _d, _e;
                                return (__assign(__assign({}, a), (_a = {}, _a[v[0]] = __assign(__assign({}, v[1]), { decimal_place: (_e = (_d = (_b = coinDetails.detail_platforms) === null || _b === void 0 ? void 0 : _b[(_c = coingeckoPlatformReverseMapping[v[0]]) !== null && _c !== void 0 ? _c : '']) === null || _d === void 0 ? void 0 : _d.decimal_place) !== null && _e !== void 0 ? _e : 18 }), _a)));
                ...
                sortedList = lodash.orderBy(newCoinList, ['market_cap'], ['desc']);
                return [4 /*yield*/, fs.promises.writeFile(path.join(config.DATA_FOLDER, 'erc20.json'), JSON.stringify(sortedList, undefined, 2))];
            case 4:
                _h.sent();
                return [2 /*return*/];
        }
