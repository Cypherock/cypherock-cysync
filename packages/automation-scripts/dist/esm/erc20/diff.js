...
import { createErc20AssetId, erc20JsonList, evmCoinList, } from '@cypherock/coins';
import lodash from 'lodash';
import { coingeckoPlatformMapping, getCoingeckoCoinList, } from './coingecko';
...
var createContractMapFromCoingeckoList = function (list) {
    ...
    for (var _i = 0, list_2 = list; _i < list_2.length; _i++) {
        ...
        for (var platform in coin.platforms) {
            if (!coin.platforms[platform])
                continue;
            var mappedPlatform = coingeckoPlatformMapping[platform];
            if (!mappedPlatform)
                continue;
...
export var getERC20TokenDifference = function (dontSaveToFile) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                return [4 /*yield*/, getCoingeckoCoinList()];
            case 1:
                coingeckoCoinMap = _a.apply(void 0, [_c.sent()]);
                existingCoinMap = createContractMapFromExistingList(erc20JsonList);
                coingeckoContractAddresses = Object.keys(coingeckoCoinMap);
                existingContractAddresses = Object.keys(existingCoinMap);
                removedContracts = lodash.difference(existingContractAddresses, coingeckoContractAddresses);
                addedContracts = lodash.difference(coingeckoContractAddresses, existingContractAddresses);
                sameContracts = lodash.intersection(coingeckoContractAddresses, existingContractAddresses);
                ...
                return [4 /*yield*/, fs.promises.writeFile(path.join(config.DATA_FOLDER, 'diff.json'), JSON.stringify({
