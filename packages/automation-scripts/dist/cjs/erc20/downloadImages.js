...
exports.downloadErc20Images = void 0;
...
var BATCH_LEN = 20;
var IMAGE_FOLDER_PATH = path_1.default.join(config_1.config.DATA_FOLDER, 'images');
    ...
    return __generator(this, function (_a) {
        ...
        return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            localFilePath = path_1.default.resolve(filePath);
                        ...
                        case 2:
                            response = _a.sent();
                            w = response.data.pipe(fs_1.default.createWriteStream(localFilePath));
        ...
        switch (_a.label) {
            ...
            case 1:
                promises = coinsToFetch.map(function (coin) {
                    var _a, _b;
                    return downloadFile((_b = (_a = coin.image) === null || _a === void 0 ? void 0 : _a.large) !== null && _b !== void 0 ? _b : '', path_1.default.join(IMAGE_FOLDER_PATH, "".concat(coin.id, ".png")));
                });
...
var downloadErc20Images = function () { return __awaiter(void 0, void 0, void 0, function () {
    var coinMap, _i, _a, coin, allCoins, chunkArray, totalFetched, _b, chunkArray_1, chunk;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                if (!!fs_1.default.existsSync(IMAGE_FOLDER_PATH)) return [3 /*break*/, 2];
                return [4 /*yield*/, fs_1.default.promises.mkdir(IMAGE_FOLDER_PATH, { recursive: true })];
            case 1:
                _d.sent();
                _d.label = 2;
            case 2:
                coinMap = {};
                for (_i = 0, _a = coins_1.erc20JsonList; _i < _a.length; _i++) {
                    coin = _a[_i];
                ...
                chunkArray = lodash_1.default.chunk(allCoins, BATCH_LEN);
                totalFetched = 0;
...
exports.downloadErc20Images = downloadErc20Images;
