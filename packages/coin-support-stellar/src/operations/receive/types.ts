...
import { GetPublicKeysEvent } from '@cypherock/sdk-app-stellar';

export type IStellarReceiveParams = IReceiveParams;

export type IStellarReceiveEvent = IReceiveEvent;
