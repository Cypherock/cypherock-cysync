...
import { SignTxnEvent } from '@cypherock/sdk-app-sia';

export type ISignSiaTransactionParams = ISignTransactionParams;

export type ISignSiaTransactionEvent = ISignTransactionEvent<string>;

export const signSiaToDeviceEventMap: Partial<
