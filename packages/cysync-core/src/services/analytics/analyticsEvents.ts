export const ANALYTICS_EVENTS = {
  ...
  BUY_CRYPTO_INPUT_PAGE_VIEWED: 'Buy Crypto - Input Page Viewed',
  BUY_CRYPTO_HISTORY_PAGE_VIEWED: 'Buy Crypto - History Page Viewed',
  BUY_CRYPTO_RECEIVE_PAGE_VIEWED: 'Buy Crypto - Receive Page Viewed',
  BUY_CRYPTO_WEBVIEW_PAGE_VIEWED: 'Buy Crypto - Webview Page Viewed',
  BUY_CRYPTO_FAILED: 'Buy Crypto - Failed',
  BUY_CRYPTO_RECEIVE_FLOW_STARTED: 'Buy Crypto - Receive Flow Started',
  BUY_CRYPTO_RECEIVE_FLOW_CLOSED: 'Buy Crypto - Receive Flow Closed',
  BUY_CRYPTO_OFFERS_REQUESTED: 'Buy Crypto - Offers Requested',
  BUY_CRYPTO_OFFERS_RECEIVED: 'Buy Crypto - Offers Received',
  BUY_CRYPTO_COUNTRY_SELECTED: 'Buy Cryto - Country Selected',
