  ...
  return (
    <Flex gap={16} $zIndex={1}>
      ...
      >
        <LangDisplay
          text={
            lang.strings.guidedFlows.walletTransferLostVault.closeDialog.buttons
              .secondary
          }
        />
      </Button>
...
export const CloseConfirmation: FC<{
  ...
  return (
    <IconDialogBox
      $isModal
      title={lang.strings.guidedFlows.walletTransferLostVault.closeDialog.title}
      subtext={
        lang.strings.guidedFlows.walletTransferLostVault.closeDialog.subtitle
      }
      ...
      pathText={
        lang.strings.guidedFlows.walletTransferLostVault.closeDialog.pathText
      }
    />
  );
};
