...
import {
  DeployAccountDialogProps,
  DeployAccountDialogProvider,
  useDeployAccountDialog,
} from './context';

export type { DeployAccountDialogProps } from './context';
...
export const DeployAccountFlow: FC = () => {
  const {
    tabs,
    currentTab,
    currentDialog,
...
export const DeployAccountDialog: FC<DeployAccountDialogProps> = props => (
  <DeployAccountDialogProvider {...props}>
    <DeployAccountFlow />
  </DeployAccountDialogProvider>
);
