...
export const FinalMessage: React.FC = () => {
  const { storedTransaction, transactionLink, onFinishDeployAccount } =
    useDeployAccountDialog();
  const lang = useAppSelector(selectLanguage);

  const displayText = lang.strings.deployAccount.finalMessage;
  ...
  return (
    <DialogBox width={500} align="center">
      ...
      <DialogBoxFooter height={101}>
        <Button variant="primary" onClick={onFinishDeployAccount}>
